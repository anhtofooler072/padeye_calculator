      ...
      <Page
        ...
        <View style={styles.summaryBox}>
          ...
          <Text
            style={[
              styles.summaryValue,
              isSafe ? styles.statusPass : styles.statusFail,
            ]}>
            {maxUC.toFixed(3)}
          </Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.tableHeader}>
            <Text style={{ width: "40%", fontSize: 10, fontWeight: "bold" }}>
              Check
            </Text>
            <Text style={{ width: "30%", fontSize: 10, fontWeight: "bold" }}>
              Value
            </Text>
            <Text style={{ width: "30%", fontSize: 10, fontWeight: "bold" }}>
              Status
          ...
          <View style={styles.tableRow}>
            <Text style={{ width: "40%", fontSize: 10 }}>
              Pin Clearance (2R3 - B)
            </Text>
            <Text style={{ width: "30%", fontSize: 10 }}>
              {clearances.pinClearance.toFixed(2)} mm
            </Text>
            <Text
              style={[
                { width: "30%", fontSize: 10 },
                clearances.pinClearance > 0
                  ? styles.statusPass
                  : styles.statusFail,
              ]}>
          ...
          <View style={styles.tableRow}>
            ...
            <Text style={{ width: "30%", fontSize: 10 }}>
              {clearances.sideClearance.toFixed(2)} mm
            </Text>
            <Text
              style={[
                { width: "30%", fontSize: 10 },
                clearances.sideClearance > 0
                  ? styles.statusPass
                  : styles.statusFail,
              ]}>
          ...
          <View style={styles.tableRow}>
            ...
            <Text style={{ width: "30%", fontSize: 10 }}>
              {clearances.shackleFit.toFixed(2)} mm
            </Text>
            <Text
              style={[
                { width: "30%", fontSize: 10 },
                clearances.shackleFit > 0
                  ? styles.statusPass
                  : styles.statusFail,
              ]}>
          ...
          <View style={styles.tableRow}>
            ...
            <Text style={{ width: "30%", fontSize: 10 }}>
              {clearances.cheekClearance.toFixed(2)} mm
            </Text>
            <Text
              style={[
                { width: "30%", fontSize: 10 },
                clearances.cheekClearance > 0
                  ? styles.statusPass
                  : styles.statusFail,
              ]}>
          ...
          {unityChecks.map((uc) => (
            <View
              ...
              <Text
                style={[
                  styles.col4,
                  uc.value <= 1.0 ? styles.statusPass : styles.statusFail,
                ]}>
                {uc.value <= 1.0 ? "OK" : "NG"}
              </Text>
            </View>
